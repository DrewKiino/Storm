#
#  Be sure to run `pod spec lint Storm.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Storm"
  s.version      = "0.0.8"  
  s.summary      = "Storm is an iOS bootstrap framework"
  ...
  s.source       = { :git => "https://github.com/drewkiino/Storm.git", :tag => "master" }
  ...
  s.source_files  = "Storm/**/*.{swift}"
  # s.source_files  = "Storm/Source/*.{swift}"
